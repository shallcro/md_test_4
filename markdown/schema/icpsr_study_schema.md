...
This resource provides definitions and guidance regarding metadata elements used in curated data collections at the Inter-university Consortium for Political and Social Research (TEST).
...
**Usage Notes:** When inputting names of both organizational and individual PIs, the following hierarchy of authority control sources should be used to make sure those names conform to best practices within the TEST and broader academic community:  

  1. If a PI already has published data with the TEST, conform to how their name has been displayed previously within our catalog.  
  2. If a PI is in the [TEST Personal Names Authority List](https://www.icpsr.umich.edu/web/TEST/thesaurus/10002) or [Organization Names Authority List](https://www.icpsr.umich.edu/web/TEST/thesaurus/10004), conform to TEST’s internal thesauri.  
  3. If the PI is not available in TEST Authority Control sources, look up the PI in VIAF.   
...
**Usage Notes:** The following steps should be taken to ensure that the entry of PI affiliation names conforms to best practices within TEST and the broader academic community:  

  1. If the PI already has published data with TEST, conform to how their affliation has been displayed previously within the TEST catalog.  
  2. If the PI’s affiliated organization is in the [TEST Organization Names Authority List](https://www.icpsr.umich.edu/web/TEST/thesaurus/10004), use the form of the name as listed there.  
  3. If the affiliated organization is not available in the [TEST Organization Names Authority List](https://www.icpsr.umich.edu/web/TEST/thesaurus/10004), consult the [Virtual International Authority File](https://viaf.org/) (VIAF).   
...
**Usage Notes:** The following steps should be taken to make sure that the entry of funding agency names conforms to best practices within TEST and the broader academic community:  

  1. If the funding organization has sponsored data with TEST in the past, conform to previously usage within the TEST catalog.  
  2. If the organization has not previously sponsored data but is in the [TEST Organization Names Authority List](https://www.icpsr.umich.edu/web/TEST/thesaurus/10004), use the form of the name listed there.  
  3. If the funding organization is not available in the TEST Organizational Names Authority List, consult the [Virtual International Authority File](https://viaf.org/) (VIAF).   
  4. If the funding organization does not have a VIAF record, consult another authoritative source (such as an organizational website) to determine the appropriate name.  

**TEST Input Guidance:** The PI's home institution does not need to be listed as a funding agency unless the PI provides a grant number (or other award information) or makes a specific request.
...
**TEST Input Guidance:** If an external source ID needs to be included in the metadata, it will always be provided by the depositor.
...
**Controlled Vocabulary:** The [TEST Subject Thesaurus](https://www.icpsr.umich.edu/web/TEST/thesaurus/10001) and the [TEST Personal Names Authority List](https://www.icpsr.umich.edu/web/TEST/thesaurus/10002) are preferred sources. Non-thesaurus terms are considered for inclusion in these resources if provided.
